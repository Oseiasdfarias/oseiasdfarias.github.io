...
const NeuralNetBackground: React.FC<{ darkMode: boolean }> = ({ darkMode }) => {
  ...
  useEffect(() => {
    ...
    const C = darkMode
      ...
      : {
          node:       '#8a6e30',
          nodeAlpha:  0.35,
          edge:       'rgba(100,80,20,0.13)',
          edgeActive: 'rgba(100,80,20,0.40)',
          edgeIO:     'rgba(100,80,20,0.22)',
          particle:   '#7a5e20',
          glow:       'rgba(100,80,20,0.14)',
          label:      'rgba(100,80,20,0.13)',
        };
    ...
    let activeLabels:  string[] = LABELS_DESKTOP;
  ...
  return (
    <canvas
      ...
      style={{ opacity: darkMode ? 0.55 : 0.22 }}
    />
  );
};
